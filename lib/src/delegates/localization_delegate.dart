...
import 'package:localizx/src/services/locale_service.dart';
import 'package:localizx/src/validators/configuration_validator.dart';
...
class LocalizationDelegate extends LocalizationsDelegate<Localization> {
  ...
  final ILocalizePreferences? preferences;
  ...
  static Future<LocalizationDelegate> create({
    ...
    ILocalizePreferences? preferences,
  }) async {
    WidgetsFlutterBinding.ensureInitialized();

    var fallback = localeFromString(fallbackLocale);
    var localesMap = await LocaleService.getLocalesMap(
      supportedLocales,
      basePath,
    );
